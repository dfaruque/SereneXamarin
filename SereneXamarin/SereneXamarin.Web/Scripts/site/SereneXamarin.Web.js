...
(function (SereneXamarin) {
    ...
    })(Authorization = SereneXamarin.Authorization || (SereneXamarin.Authorization = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var Administration;
...
(function (SereneXamarin) {
    ...
    })(BasicSamples = SereneXamarin.BasicSamples || (SereneXamarin.BasicSamples = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var Northwind;
    (function (Northwind) {
        var ProductDialog = (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () {
                return SereneXamarin.LanguageList.getValue();
            };
    ...
    })(Northwind = SereneXamarin.Northwind || (SereneXamarin.Northwind = {}));
})(SereneXamarin || (SereneXamarin = {}));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneXamarin.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SereneXamarin.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SereneXamarin.Common.ReportHelper.execute({
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneXamarin.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneXamarin.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneXamarin.Northwind.OrderDialog();
                        ...
                        var chai = SereneXamarin.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneXamarin.Northwind.EmployeeRow.getLookup().items
        ...
        }(SereneXamarin.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SereneXamarin.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Northwind.OrderDialog));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    SereneXamarin.Northwind.CategoryService.Retrieve({
        ...
        }(SereneXamarin.Northwind.CategoryDialog));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                this.customerPropertyGrid = new Serenity.PropertyGrid(this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(SereneXamarin.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                this.customerForm = new SereneXamarin.Northwind.CustomerForm(this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SereneXamarin.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SereneXamarin.Northwind.CustomerRow.lookupKey);
                ...
                this.form.CustomerID.change(function (e) {
                    ...
                    SereneXamarin.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SereneXamarin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneXamarin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneXamarin.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneXamarin.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneXamarin.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneXamarin.Northwind.OrderService.baseUrl; };
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Northwind.SupplierDialog));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SereneXamarin.Northwind.SupplierGrid));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneXamarin.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneXamarin.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneXamarin.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneXamarin.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneXamarin.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
            }
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneXamarin.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneXamarin.Northwind.CustomerDialog));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Northwind.CustomerGrid));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = SereneXamarin.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(SereneXamarin.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SereneXamarin.Northwind.ProductRow.lookupKey;
            };
...
(function (SereneXamarin) {
    ...
    (function (Northwind) {
        ...
        }(SereneXamarin.Common.GridEditorBase));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Northwind.OrderDetailsEditor));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneXamarin.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneXamarin.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneXamarin.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new SereneXamarin.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = SereneXamarin.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(SereneXamarin.Northwind.OrderDetailDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneXamarin.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SereneXamarin) {
    ...
    SereneXamarin.StaticTextBlock = StaticTextBlock;
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var BasicSamples;
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneXamarin.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneXamarin.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneXamarin.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = SereneXamarin.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = SereneXamarin.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneXamarin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneXamarin.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneXamarin.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneXamarin.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, SereneXamarin.Northwind.OrderRow.Fields.ShipCountry);
...
(function (SereneXamarin) {
    ...
    SereneXamarin.SelectableEntityGrid = SelectableEntityGrid;
})(SereneXamarin || (SereneXamarin = {}));
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SereneXamarin.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SereneXamarin.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SereneXamarin.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SereneXamarin.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = SereneXamarin.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SereneXamarin.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneXamarin.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneXamarin.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneXamarin.Northwind.ProductService.baseUrl; };
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SereneXamarin.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SereneXamarin.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SereneXamarin.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: SereneXamarin.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneXamarin.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneXamarin.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneXamarin.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (SereneXamarin) {
    ...
    SereneXamarin.BasicProgressDialog = BasicProgressDialog;
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneXamarin.BasicProgressDialog();
...
(function (SereneXamarin) {
    ...
    })(DialogUtils = SereneXamarin.DialogUtils || (SereneXamarin.DialogUtils = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var Common;
...
(function (SereneXamarin) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneXamarin.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneXamarin.LanguageList || (SereneXamarin.LanguageList = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var Administration;
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SereneXamarin.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneXamarin.BasicSamples || (SereneXamarin.BasicSamples = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SereneXamarin.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return SereneXamarin.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneXamarin.BasicSamples || (SereneXamarin.BasicSamples = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return SereneXamarin.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return SereneXamarin.StaticTextBlock; }], ['FromLocalText', function () { return SereneXamarin.StaticTextBlock; }], ['DisplayFieldValue', function () { return SereneXamarin.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneXamarin.BasicSamples || (SereneXamarin.BasicSamples = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
...
(function (SereneXamarin) {
    ...
    })(Meeting = SereneXamarin.Meeting || (SereneXamarin.Meeting = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var Meeting;
...
(function (SereneXamarin) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'SereneXamarin.Northwind.Entities.Gender');
    })(Northwind = SereneXamarin.Northwind || (SereneXamarin.Northwind = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
...
(function (SereneXamarin) {
    ...
    })(Organization = SereneXamarin.Organization || (SereneXamarin.Organization = {}));
})(SereneXamarin || (SereneXamarin = {}));
var SereneXamarin;
(function (SereneXamarin) {
    var Organization;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: SereneXamarin.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = SereneXamarin.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneXamarin.Authorization.userDefinition.DisplayName,
...
(function (SereneXamarin) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneXamarin.Common.BulkServiceAction));
...
//# sourceMappingURL=SereneXamarin.Web.js.map